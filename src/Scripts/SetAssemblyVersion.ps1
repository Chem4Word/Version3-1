...
$findPattern = 'string DefaultMsiFile = "https://www.chem4word.co.uk/files3-1/Chem4Word-Setup.*'
$replaceWith = 'string DefaultMsiFile = "https://www.chem4word.co.uk/files3-1/Chem4Word-Setup.' + "$($version).$($dottedname)" + '.msi";'
